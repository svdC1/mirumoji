...
>         ```
>         _Security Note:_ On newer macOS versions, you might see a security warning the first time you run it because it's a downloaded application. You may need to go to "System Settings" > "Privacy & Security", scroll down, and click "Open Anyway" or allow the app.
> -   **Linux:**
